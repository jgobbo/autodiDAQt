...
import numpy as np
from daquiri_common.enum import _try_unwrap_value
...
from daquiri.utils import AccessRecorder, InstrumentScanAccessRecorder, PathType
...
def scan(
    ...
    **axes: Union[str, ScanDegreeOfFreedom, AccessRecorder],
    ...
    def sequence_scan(self, experiment, **kwargs):
        dependent = {
            read_name: AxisPath.to_tuple(read_device)
