...
from daquiri_common.collation import Collation, CollationInfo
from daquiri_common.path import AxisPath
from daquiri_common.remote import schema
...
from daquiri.actor import StopException
from daquiri.experiment.save import save_on_separate_thread
...
from daquiri.utils import ScanAccessRecorder
...
class Experiment(FSM):
    ...
    async def save(self, *_):
        ...
        save_function = config.save_data if hasattr(config, "save_data") else None
