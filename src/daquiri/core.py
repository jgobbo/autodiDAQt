...
from daquiri_common.remote.middleware import (
    TranslateCommandsMiddleware,
    WireMiddleware,
)
from daquiri_common.remote.schema import RemoteApplicationState, TypeDefinition
...
from daquiri.remote.link import RemoteLink
...
class DaquiriMainWindowHeadless:
    open_panels = {}
...
class Daquiri:
    ...
    def start(self):  # pragma: no cover
        ...
        main_window_cls = (
            DaquiriMainWindowHeadless if self.cli_config.headless else DaquiriMainWindow
        )
