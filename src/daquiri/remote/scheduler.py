...
from daquiri_common.remote.socket import AsyncBufferedSocket
...
class PairScheduler:
    ...
    @classmethod
    def run_with_standard_middleware(
        cls, process: Process, remote_config: RemoteConfiguration
    ):
        scheduler = cls(
